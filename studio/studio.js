...
function buildProps(kind,B,amp,ov){
  ...
  switch(kind){
   ...
   case"drop": p=PO([[0,256-a*5,ES],[0.55,256,EI],[0.7,256-a*1.2,ES],[0.85,256,EI],[1,256]]);o=A([kf(0,[0]),kf(0.3*B,[100]),kf(0.85*B,[100]),kf(B,[0])]);break;
   case"rise": p=PO([[0,256+a*5,ES],[0.6,256,EZ],[1,256]]);o=A([kf(0,[0]),kf(0.45*B,[100]),kf(0.85*B,[100]),kf(B,[0])]);break;
